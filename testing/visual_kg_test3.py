...
OUTPUT_FILE = r"C:\TA KG Baru\data work\data\visual graf\visual_instance_core.html"
LIMIT = 10   # jumlah MemePost yang divisualisasikan

sparql = SPARQLWrapper(FUSEKI_URL)
sparql.setReturnFormat(JSON)

# ======================================================
# SPARQL QUERY (INSTANCE-LEVEL, VISUALIZATION READY)
# ======================================================
sparql.setQuery(f"""
...
def safe_node_id(prefix, value: str):
    """Buat ID node deterministik agar tidak duplikat"""
