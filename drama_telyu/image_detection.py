...
IMAGE_DIR = r"C:\TA KG Baru\data work\data modelling\drama_telyu\data\images2"
INPUT_PATH = r"C:\TA KG Baru\data work\data modelling\drama_telyu\data\cleaned_data_dratel.xlsx"
OUTPUT_JSON_PATH = r"C:\TA KG Baru\data work\data modelling\drama_telyu\data\data_with_image_and_text2.json"

OUTPUT_XLSX_PATH = r"C:\TA KG Baru\data work\data modelling\drama_telyu\data\data_with_image_and_text2.xlsx"
...
def process_images(input_path, image_dir, output_json_path, output_xlsx_path=None):
    ...
    for entry in data:
        pid = entry.get("id") or entry.get("post_id")  
        try:
            if pid is None:
